...
export const routes: RouteRecordRaw[] = [
  ...
  { path: '/director/reactivar-cuenta/:cedula', component: lazy(() => import('@/vistas/director/ReactivarCuenta.vue')) },
  { path: '/director/restablecer-password/:cedula', redirect: to => `/director/reactivar-cuenta/${to.params.cedula}` },
