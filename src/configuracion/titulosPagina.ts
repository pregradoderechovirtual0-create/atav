...
const PAGE_TITLES: Record<string, PageHeaderInfo> = {
  ...
  "/docente/crear-solicitud": {
    ...
    subtitle: "Crear solicitud de ausentismo",
  },
  ...
  "/docente/materias-asignadas": {
    ...
    subtitle: "Asignaturas a tu cargo",
  },
  "/docente/notificaciones": {
    title: "Notificaciones",
    subtitle: "Notificaciones actualizadas",
  },
  "/docente/recursos": {
    title: "Recursos",
    subtitle: "Formatos y documentos oficiales",
  },
  "/docente/calendario": {
    title: "Calendario",
  ...
  "/director/solicitudes": {
    title: "Solicitudes",
    subtitle: "Gestionar solicitudes del programa",
  },
  "/director/reportes": {
    title: "Reportes",
    subtitle: "Estadísticas y reportes",
  },
  "/director/notificaciones": {
    title: "Notificaciones",
    subtitle: "Notificaciones actualizadas",
  },
  "/director/usuarios": { title: "Usuarios", subtitle: "Usuarios registrados" },
  "/director/usuarios/crear": {
    title: "Crear usuario",
    subtitle: "Registrar nuevo usuario",
  },
  "/director/materias": {
    title: "Materias",
    subtitle: "Asignaturas registradas",
  },
  "/director/parciales": {
    title: "Fechas de parciales",
    subtitle: "Rangos de fechas por parcial",
  },
  "/director/llamadas": { title: "Llamadas", subtitle: "Llamadas registradas" },
  "/director/aspirantes": {
    title: "Aspirantes",
    subtitle: "Estudiantes interesados",
  },
  "/director/recursos": {
    title: "Recursos",
    subtitle: "Formatos y documentos oficiales",
  ...
  "/estudiante/materias": {
    title: "Mis materias",
    subtitle: "Selecciona tus materias del semestre actual",
  },
  "/estudiante/crear-solicitud": {
    title: "Nueva Solicitud",
    subtitle: "Solicitar excusa académica",
  },
  ...
  "/estudiante/flexibilidad": {
    ...
    subtitle: "Solicitar flexibilización de parcial",
  },
  "/estudiante/supletorios": {
    title: "Supletorios",
    subtitle: "Solicitar examen supletorio",
  },
  "/estudiante/habilitaciones": {
    title: "Habilitaciones",
    subtitle: "Solicitar habilitación de materia",
  },
  "/estudiante/recursos": {
    title: "Recursos",
    subtitle: "Formatos y documentos oficiales",
...
export function headerInfoForPath(path: string): PageHeaderInfo {
  ...
  if (normalized.startsWith("/docente/solicitud/")) {
    return {
      ...
      subtitle: "Información de tu solicitud",
    };
  }
  if (normalized.startsWith("/director/reactivar-cuenta/")) {
    return {
      title: "Reactivar cuenta",
      subtitle: "Restablecer acceso sin borrar datos del usuario",
    };
  }
  ...
  if (normalized.startsWith("/director/aspirantes/editar/")) {
    return {
      ...
      subtitle: "Actualizar datos del aspirante",
    };
  }
...
export function mobileBarTitleForPath(
  path: string,
  headerTitle: string,
): string {
  ...
  if (
    ...
    normalized === "/director" ||
    normalized.startsWith("/docente/dashboard")
  ) {
    return "Inicio";
  }
  return "ATAV";
