...
const guardar = async () => {
  ...
  try {
    if (modoEdicion.value && aspiranteEditando.value) {
      ...
      const idx = aspirantes.value.findIndex(
        (a) => a.id === aspiranteEditando.value.id,
      );
      if (idx !== -1)
        aspirantes.value[idx] = { ...aspirantes.value[idx], ...datos };
...
const confirmarEliminacion = async () => {
  ...
  try {
    ...
    aspirantes.value = aspirantes.value.filter(
      (a) => a.id !== aspiranteAEliminar.value.id,
    );
  ...
  <div class="director-list-page">
    ...
    <section class="table-section">
      ...
      <div v-else class="table-card">
        ...
        <div v-if="aspirantesFiltrados.length === 0" class="empty-panel">
          ...
          <p class="empty-desc">
            Prueba otro filtro o registra un nuevo aspirante.
          </p>
          <button
            type="button"
          ...
          <table class="data-table">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  <span
                    :class="['status-badge', badgeEstado(aspirante.estado)]"
                  >
                    {{ aspirante.estado }}
                  </span>
                </td>
                <td>
                  <div class="row-actions">
                    <button
                      ...
                      aria-label="Editar"
                      title="Editar"
                      @click.stop="abrirModalEditar(aspirante)"
                    >
                      <svg
                        width="16"
                        height="16"
                    ...
                    <button
                      ...
                      aria-label="Eliminar"
                      title="Eliminar"
                      @click.stop="eliminarAspirante(aspirante)"
                    >
                      <svg
                        width="16"
                        height="16"
        ...
        <div v-if="aspirantesFiltrados.length > 0" class="table-footer">
          <span>
            {{ aspirantesFiltrados.length }} aspirante{{
              aspirantesFiltrados.length === 1 ? "" : "s"
            }}
    ...
    <Teleport to="body">
      <Transition name="modal">
        ...
        >
          <div
            class="modal-card modal-form modal-form--wide"
            role="dialog"
            aria-modal="true"
          >
            <div class="modal-top">
              <div class="modal-top-row">
                ...
                <div class="modal-top-text">
                  <h2 class="modal-title">
                    {{ modoEdicion ? "Editar aspirante" : "Nuevo aspirante" }}
                  </h2>
            ...
            <div class="modal-body">
              <section class="modal-section">
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="aspirante-cedula"
                      >Cédula *</label
                    >
                    <input
                      id="aspirante-cedula"
                  ...
                  <div class="field-group">
                    <label class="field-label" for="aspirante-nombre"
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="aspirante-correo"
                      >Correo *</label
                    >
                    <input
                      id="aspirante-correo"
                  ...
                  <div class="field-group">
                    <label class="field-label" for="aspirante-celular"
                      >Celular *</label
                    >
                    <input
                      id="aspirante-celular"
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="aspirante-telefono"
                      >Teléfono</label
                    >
                    <input
                  ...
                  <div class="field-group">
                    <label class="field-label" for="aspirante-lugar"
                      >Lugar de residencia</label
                    >
                    <input
                      id="aspirante-lugar"
                      v-model="form.lugarResidencia"
                      type="text"
                      class="field-input"
              ...
              <section class="modal-section">
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="aspirante-tipo"
                      >Tipo de inscripción</label
                    >
                    <div class="select-wrapper">
                      <select
                        id="aspirante-tipo"
                        v-model="form.tipoInscripcion"
                        class="field-input field-select"
                      >
                        <option value="" disabled>Selecciona...</option>
                        <option
                          v-for="t in tiposInscripcion"
                          :key="t"
                          :value="t"
                        >
                          {{ t }}
                  ...
                  <div class="field-group">
                    <label class="field-label" for="aspirante-estado"
                      >Estado</label
                    >
                    <div class="select-wrapper">
                      <select
                ...
                <div class="field-group">
                  ...
                  <input
                    ...
                    type="text"
                    class="field-input"
                    placeholder="Ej. Inclusión, General..."
                  />
                </div>
                <div class="field-group">
                  <label class="field-label" for="aspirante-obs"
                    >Observaciones</label
                  >
                  <textarea
                    id="aspirante-obs"
                    ...
                    placeholder="Información adicional sobre el aspirante..."
                  />
                </div>
              </section>
            </div>
