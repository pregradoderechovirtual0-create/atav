...
const verDetalleLlamada = (llamada: any) => {
  ...
  detalleSubtitle.value = [llamada.fecha, llamada.hora]
    .filter(Boolean)
    .join(" · ");
...
const guardar = async () => {
  ...
  try {
    if (modoEdicion.value && llamadaEditando.value) {
      ...
      const idx = llamadas.value.findIndex(
        (l) => l.id === llamadaEditando.value.id,
      );
      if (idx !== -1)
        llamadas.value[idx] = {
          ...llamadas.value[idx],
    ...
    <section class="table-section">
      ...
      <div v-else class="table-card">
        <div class="table-card-header">
          <div>
            ...
            <p class="table-subtitle">
              {{ llamadasFiltradas.length }} resultado{{
                llamadasFiltradas.length === 1 ? "" : "s"
              }}
        ...
        <div v-if="llamadasFiltradas.length === 0" class="empty-panel">
          ...
          <p class="empty-desc">
            Prueba otro filtro o registra una nueva llamada.
          </p>
          <button
            type="button"
                ...
                <td>
                  <div class="row-actions">
                    <button
                      ...
                      aria-label="Editar"
                      title="Editar"
                      @click.stop="abrirModalEditar(llamada)"
                    >
                      <svg
                        width="16"
                        height="16"
                    ...
                    <button
                      ...
                      aria-label="Eliminar"
                      title="Eliminar"
                      @click.stop="eliminar(llamada.id)"
                    >
                      <svg
                        width="16"
                        height="16"
        ...
        <div v-if="llamadasFiltradas.length > 0" class="table-footer">
          <span>
            {{ llamadasFiltradas.length }} registro{{
              llamadasFiltradas.length === 1 ? "" : "s"
            }}
          ...
          >
              ...
              <div class="modal-top-row">
                ...
                <div class="modal-top-text">
                  <h2 class="modal-title">
                    {{ modoEdicion ? "Editar llamada" : "Nueva llamada" }}
                  </h2>
            ...
            <div class="modal-body">
              <section class="modal-section">
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="llamada-fecha"
                      >Fecha *</label
                    >
                    <input
                      id="llamada-fecha"
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="llamada-nombre"
                      >Nombre *</label
                    >
                    <input
                      id="llamada-nombre"
                  ...
                  <div class="field-group">
                    <label class="field-label" for="llamada-telefono"
                      >Teléfono</label
                    >
                    <input
                      id="llamada-telefono"
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="llamada-estamento"
                      >Estamento</label
                    >
                    <div class="select-wrapper">
                      <select
                        id="llamada-estamento"
                        v-model="form.estamento"
                        class="field-input field-select"
                      >
                        <option value="" disabled>Selecciona...</option>
                        <option v-for="e in estamentos" :key="e" :value="e">
                          {{ e }}
                        </option>
                      </select>
                      <svg
                  ...
                  <div class="field-group">
                    <label class="field-label" for="llamada-prioridad"
                      >Prioridad</label
                    >
                    <div class="select-wrapper">
                      <select
                        id="llamada-prioridad"
                ...
                <div class="field-group">
                  <label class="field-label" for="llamada-asunto"
                    >Asunto *</label
                  >
                  <textarea
                    id="llamada-asunto"
              ...
              <section class="modal-section">
                ...
                <div class="field-row">
                  <div class="field-group">
                    <label class="field-label" for="llamada-estado"
                      >Estado</label
                    >
                    <div class="select-wrapper">
                      <select
                  ...
                  <div class="field-group">
                    <label class="field-label" for="llamada-prox"
                      >Próxima acción</label
                    >
                    <input
                      id="llamada-prox"
                      v-model="form.proxAccion"
                      class="field-input"
                ...
                <div class="field-group">
                  <label class="field-label" for="llamada-notas"
