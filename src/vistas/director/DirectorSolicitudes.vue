        ...
        await crearNotificacion({
          ...
          mensaje: esAprobada
            ? `Solicitud aprobada. Nueva fecha: ${
                opcionReprogramacionSeleccionada.value
                  ? formatFechaHoraSolicitud(
                      opcionReprogramacionSeleccionada.value.inicio,
                    )
                  : "Sin reprogramación"
              }. ${mensajeDirector.value || ""}`
...
const fechasReprogramacionLista = (sol: SolicitudDirector) =>
  (sol.fechas_reprogramacion || []).filter((fecha: any) => fecha?.inicio);
</script>
  ...
  <div class="solicitudes-page">
    ...
    <div class="pagination">
      <span class="pagination-info"
        >{{ solicitudesFiltradas.length }} solicitudes</span
      >
    </div>
                ...
                <div class="detail-grid detail-grid--3">
                  <div class="detail-item">
                    ...
                    <span class="detail-value detail-value--highlight"
                      >Parcial {{ solicitudSeleccionada.parcial ?? "—" }}</span
                    >
                  </div>
                  ...
                  <div
                    ...
                    :class="{
                      'repro-opcion--seleccionada':
                        opcionReprogramacionSeleccionada?.inicio ===
                        fecha.inicio,
                    }"
