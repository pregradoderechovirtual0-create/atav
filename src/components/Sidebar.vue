...
import { mapRolMenu } from '@/lib/roles'
import { obtenerSesion } from '@/lib/session'
import { useSidebar } from '@/composables/useSidebar'
import AtavBrand from '@/components/AtavBrand.vue'
...
const menuItems = computed(() => {
  if (role.value === 'docente') {
    return [
      ...
      { name: 'Mis solicitudes', path: '/docente/mis-solicitudes', icon: 'file' },
      { name: 'Materias asignadas', path: '/docente/materias-asignadas', icon: 'book' },
  ...
  if (role.value === 'director') {
    return [
      ...
      { name: 'Fechas parciales', path: '/director/parciales', icon: 'calendar' },
  ...
  return [
    ...
    { name: 'Solicitar flexibilización', path: '/estudiante/flexibilidad', icon: 'calendar-clock' },
    { name: 'Solicitar supletorio', path: '/estudiante/supletorios', icon: 'file-check' },
    { name: 'Solicitar habilitación', path: '/estudiante/habilitaciones', icon: 'book-open' },
...
<template>
  ...
  >
    <div class="sidebar-header" :class="{ 'sidebar-header--collapsed': !isOpen && !isMobile }">
      <AtavBrand
        variant="sidebar"
        size="md"
      ...
      >
        <svg class="mobile-close-icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      >
        <svg class="back-flag" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <li v-for="item in menuItems" :key="item.path">
          ...
          >
            <span class="nav-icon">
              ...
              <svg v-else-if="item.icon === 'plus'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <line x1="12" y1="5" x2="12" y2="19"/>
                <line x1="5" y1="12" x2="19" y2="12"/>
              </svg>
              <svg v-else-if="item.icon === 'file'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <svg v-else-if="item.icon === 'inbox'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <svg v-else-if="item.icon === 'user-plus'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <svg v-else-if="item.icon === 'book-open'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/>
                <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/>
              </svg>
              <svg v-else-if="item.icon === 'calendar-clock'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <svg v-else-if="item.icon === 'file-check'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                <polyline points="14 2 14 8 20 8"/>
              ...
              <svg v-else-if="item.icon === 'phone'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
<svg v-else-if="item.icon === 'calendar'" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
