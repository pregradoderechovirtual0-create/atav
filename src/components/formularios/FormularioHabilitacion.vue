...
interface FormularioHabilitacionData {
  tipo: 'habilitacion'
  estado: 'pendiente'
  datos: {
    semestre: string
...
const emit = defineEmits<{
  crear: [data: FormularioHabilitacionData]
}>()
...
<template>
  <div class="formulario-supletorio"><!-- 👈 usamos el MISMO estilo -->
      ...
      <div v-if="currentStep === 1" class="step-content">
        ...
        <div class="form-grid">
          <div class="form-group full-width">
            ...
            <input v-model="formData.nombreEstudiante" class="form-input" placeholder="Escriba su nombre completo"/>
          </div>
          ...
          <div class="form-group full-width">
            ...
            <input v-model="formData.documentoEstudiante" class="form-input" placeholder="Escriba su número de documento"/>
          </div>
        </div>
      </div>
      ...
      <div v-if="currentStep === 2" class="step-content">
        ...
        <div class="form-grid">
          <div class="form-group full-width">
            <label class="form-label">
              <span class="required">*</span>
              Semestre de la materia a habilitar
            </label>
          ...
          <div class="form-group full-width">
            ...
            <input v-model="formData.docente" class="form-input" placeholder="Nombre del docente"/>
          </div>
          ...
          <div class="form-group full-width">
            ...
            <input v-model="formData.nombreCurso" class="form-input" placeholder="Nombre del curso"/>
          </div>
        </div>
      </div>
      ...
      <div v-if="currentStep === 3" class="step-content">
        ...
        <div class="form-grid">
          <div class="form-group full-width">
            ...
            <input v-model="formData.unidades" class="form-input"/>
          </div>
          ...
          <div class="form-group full-width">
            ...
            <input v-model="formData.actividades" class="form-input"/>
          </div>
        </div>
      </div>
