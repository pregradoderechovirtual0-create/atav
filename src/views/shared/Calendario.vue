...
import { fetchMaterias, filtrarMateriasPorProfesor, type MateriaRegistrada } from '@/lib/materias'
import { mapDocSolicitud, eventosCalendarioDesdeSolicitud } from '@/lib/docenteSolicitudes'
...
// ← CAMBIO: claves en minúsculas sin tilde
const diaSemanaMap: Record<string, number> = {
  'domingo': 0, 'lunes': 1, 'martes': 2, 'miercoles': 3,
  'jueves': 4, 'viernes': 5, 'sabado': 6,
}

// ← NUEVO: normaliza el campo dia de Firestore para hacer match
...
const clasesDelMes = computed(() => {
  ...
  materiasVisibles.value.forEach(m => {
    // ← CAMBIO: usa normalizarDia para hacer match sin importar tildes o mayúsculas
