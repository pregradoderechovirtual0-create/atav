...
import { iniciarSesionConCedula, LoginError } from '@/lib/authLogin'
import { hashPassword } from '@/lib/passwordUtils'
import { rutaInicioPorRol } from '@/lib/rutas'
import { sincronizarSesionLocal } from '@/lib/session'
...
const login = async () => {
  ...
  try {
    ...
    if (error instanceof LoginError && error.code === 'NOT_FOUND') {
...
const registrar = async () => {
  ...
  try {
    ...
    if (userSnap.data().registrado === true) {
