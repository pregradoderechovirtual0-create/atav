...
import { restablecerPasswordUsuario } from '@/lib/resetPassword'
...
const cambiarPasswordAdmin = async () => {
  ...
  try {
    ...
    mensaje.value = authSincronizado
      ...
      : 'Contraseña actualizada. El usuario puede entrar con la nueva clave (se validará al iniciar sesión).'
